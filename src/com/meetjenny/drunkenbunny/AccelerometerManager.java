...
public class AccelerometerManager {
    ...
    public static boolean isSupported(Context context) {
        ...
        if (supported == null) {
            if (aContext != null) {
                ...
                List<Sensor> accel_sensors = sensorManager.getSensorList(Sensor.TYPE_ACCELEROMETER);  
                
                
                
                supported = new Boolean(accel_sensors.size() > 0);
            } else {
    ...
    public static void startListening( AccelerometerListener accelerometerListener ) 
    {
        ...
        List<Sensor> accel_sensors = sensorManager.getSensorList(
        		Sensor.TYPE_ACCELEROMETER);
        
        if (accel_sensors.size() > 0) {
            sensor = accel_sensors.get(0);
